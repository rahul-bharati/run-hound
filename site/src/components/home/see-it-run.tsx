...
const tabs: TourTab[] = [
  {
    ...
    text: "Enter the address of a page on your machine. Run Hound finds everything on it (here Kennel's “Book a sitter” form with 9 fields, a button outside the form, and the page itself) and plans 20 scenarios in three groups, each saying what it tests and which test records it creates. Nothing runs until you approve. The plan comes from what Run Hound finds on the page; AI planning is coming soon.",
