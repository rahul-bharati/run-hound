export const site = {
  ...
  description:
    "Open-source, AI-assisted UI testing for AI-built apps. Point it at a page on your local app, approve the plan (optionally reviewed by your own AI model), and get a report of broken flows, accessibility failures, missing protections and leaks, each with evidence and a Playwright test.",
  // Current release: the V1 ("Single page") open-source preview, with optional AI since 0.3.0. V0 ("Single form", 0.1.0) shipped before it.
  release: "V1",
