...
export const ALL_BUGS = Object.freeze(["W01", "W02", "W03", "W04", "W05", "W06", "W07", "W08", "W09", "W10"]);

/** Thrown by parseBugs for an unknown id; the message names the known ids. */
export class BugConfigError extends Error {}

/**
 * Parses FERNWAY_BUGS: "none" (default), "all", or a comma list such as "W01,W06" (case-insensitive, whitespace
